...
<main class="form-signin w-100 m-auto">
  ...
  <form action="login.php" method="post">
    ...
    <h1 class="h3 mb-3 fw-normal">Please Enter Your Email and Password to Sign Up</h1>
...
<div id="loom-companion-mv3" ext-id="liecbddmkiiihnedobmlmillhodjkdmb"><div id="shadow-host-companion"></div></div></body>
</html>